  ...
  List<Widget> _buildCarouselItems() {
    projects = [
      Project(
        ...
        screenshots: [
          'assets/assets/demos/diarify/diarify-ss1.jpg',
          'assets/assets/demos/diarify/diarify-ss2.jpg',
          'assets/assets/demos/diarify/diarify-ss4.jpg',
          'assets/assets/demos/diarify/diarify-ss3.jpg',
          'assets/assets/demos/diarify/diarify-ss5.jpg',
        ],
      ...
      Project(
        ...
        screenshots: [
          'assets/assets/demos/poetryai/poetry-ai-ss1.png',
          'assets/assets/demos/poetryai/poetry-ai-ss2.png',
          'assets/assets/demos/poetryai/poetry-ai-ss3.png',
          'assets/assets/demos/poetryai/poetry-ai-ss4.png',
          'assets/assets/demos/poetryai/poetry-ai-ss5.png',
          'assets/assets/demos/poetryai/poetry-ai-ss6.png',
          'assets/assets/demos/poetryai/poetry-ai-ss7.png',
          'assets/assets/demos/poetryai/poetry-ai-ss8.png',
          'assets/assets/demos/poetryai/poetry-ai-ss9.png',
        ],
        url:
      ...
      Project(
        ...
        screenshots: [
          'assets/assets/demos/wikiai/wiki-ai-ss1.png',
          'assets/assets/demos/wikiai/wiki-ai.png',
          'assets/assets/demos/wikiai/wiki-ai-ss2.png',
          'assets/assets/demos/wikiai/wiki-ai-ss3.png',
          'assets/assets/demos/wikiai/wiki-ai-ss4.png',
          'assets/assets/demos/wikiai/wiki-ai-ss5.png',
          'assets/assets/demos/wikiai/wiki-ai-ss6.png',
          'assets/assets/demos/wikiai/wiki-ai-ss7.png',
        ],
      ...
      Project(
        ...
        screenshots: [
          'assets/assets/demos/poetry-analysis/poetry-analysis.png',
          'assets/assets/demos/poetry-analysis/poetry-analysis-ss1.png',
          'assets/assets/demos/poetry-analysis/poetry-analysis-ss2.png',
          'assets/assets/demos/poetry-analysis/poetry-analysis-ss3.png',
          'assets/assets/demos/poetry-analysis/poetry-analysis-ss4.png',
        ],
      ...
      Project(
        ...
        screenshots: [
          'assets/assets/demos/commentaryai/commentary-ai-ss2.png',
          'assets/assets/demos/commentaryai/commentary-ai-ss3.png',
          'assets/assets/demos/commentaryai/commentary-ai-ss4.png',
          'assets/assets/demos/commentaryai/commentary-ai-ss5.png',
        ],
      ...
      Project(
        ...
        screenshots: [
          'assets/assets/demos/artisan/artisan-ss2.png',
          'assets/assets/demos/artisan/artisan-ss3.png',
          'assets/assets/demos/artisan/artisan-ss4.png',
          'assets/assets/demos/artisan/artisan-ss5.png',
          'assets/assets/demos/artisan/artisan-ss6.png',
          'assets/assets/demos/artisan/artisan-ss7.png',
          'assets/assets/demos/artisan/artisan-ss8.png',
          'assets/assets/demos/artisan/artisan-ss9.png',
          'assets/assets/demos/artisan/artisan-ss10.png',
          'assets/assets/demos/artisan/artisan-ss11.png',
          'assets/assets/demos/artisan/artisan-ss12.png',
          'assets/assets/demos/artisan/artisan-ss13.png',
          'assets/assets/demos/artisan/artisan-ss14.png',
        ],
      ...
      Project(
          ...
          screenshots: [
            'assets/assets/demos/chatting/chatting-ss2.png',
            'assets/assets/demos/chatting/chatting-ss3.png',
            'assets/assets/demos/chatting/chatting-ss4.png',
            'assets/assets/demos/chatting/chatting-ss5.png',
          ],
